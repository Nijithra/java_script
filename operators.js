...
console.log("Arithmetic Operator Post Increment:",aA++)
console.log("Arithmetic Operator Pre Increment:",++aA)
console.log("Arithmetic Operator Post Decrement:",aA--)
console.log("Arithmetic Operator Pre Decrement:",--aA)
console.log("\n")
